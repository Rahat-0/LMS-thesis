        ...
        <>
            ...
            <div className="relative flex items-center justify-between h-16">
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  <img
                    className="block lg:hidden ml-8 h-10  w-auto"
                    src={logo}
                    alt="nuist"
                  />
                  <img
                    className="hidden lg:block ml-8 h-9 w-auto"
                    src={logo}
                    alt="nuist"
                  />
                </div>
                ...
                <div className="hidden sm:block sm:ml-6">
                  <div className="flex space-x-4">
                    {/* <a className="text-gray-300 hover:bg-gray-700 hover:text-white">a</a> */}
                  </div>
                </div>
              </div>
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <Disclosure.Button className="text-gray-300 hover:bg-gray-700 hover:text-white"></Disclosure.Button>
            </div>
          </Disclosure.Panel>
        </>
      )}
