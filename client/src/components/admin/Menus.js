...
function Menus(props) {
  ...
  return (
      <div>
          <MenuIcon onClick={()=>{setVisible(!visible)}} className="w-8 h-8 fixed z-10 top-4 left-4 text-white" />
    <div
      className={` ${visible ? "block" : "hidden"} bg-gray-800 w-80 pl-4 fixed overflow-y-auto`}
      style={{ height: "90vh" }}
    >
